...
- [1] 重构敌人脚本，使用策略模式的方式，在每个子策略的内部进行实际的计算->改用接口，将敌人的移动，攻击等方式用接口实现，具体的参数在策略中 🛫 2025-07-13 ⏳ 2025-07-14 📅 2025-07-14
	- [ ] 修复逻辑上的错误，当敌人移动时遇上玩家，发生碰撞而停下脚步
- [ ] 丰富敌人种类，添加更多种敌人 🛫 2025-07-13 ⏳ 2025-07-14 📅 2025-07-14
...
- [x] 添加关卡内玩家生成区域和敌人生成区域 🛫 2025-09-25 📅 2025-09-28 ✅ 2025-11-19
	...
	- [x] 出生区域参考： ✅ 2025-11-19
		- [ ] ![[file-20250925224908071.png]]
	- [ ] 开始部署时UI显示参考：
		- [ ] ![[file-20250925222835073.png]]
		- [ ] ![[file-20250925222845319.png]]
- [1] 添加上下层与本层的视觉效果
	- [ ] 上下层虚化
	- [x] 本层添加选中效果，类似于下图： ✅ 2026-01-04
		- [x] ![[选中当前层.png]] ✅ 2026-01-04  🏁 ![[楼层选中.gif]]
- [ ] 完善敌人info面板，支持鼠标悬停&详细状态面板 🔺 ➕ 2025-11-19
	...
	- [x] 其他的锁定逻辑显示也同陷阵之志一样 ✅ 2026-01-04
		- [x] 选中敌人之后的红色描边![[选中敌人之后的表现.png]] 🛫 2025-11-28 ✅ 2026-01-04
		- [x] 选中友军之后的绿色描边 ![[选中友军之后的表现.png]] 🛫 2025-11-28 ✅ 2026-01-04
	- [ ] 优化寻路表现 🛫 2025-11-28
		- [ ] 优化玩家寻路时没有实时更新对应的移动路径(没有清除原先选择的路径下的arrowSprite) ![[2025.11.28 移动下显示bug.png]]
		- [ ] 优化移动下的显示逻辑，也支持预览效果，详细效果如图：![[友军移动时图例.png]] 🛫 2025-11-28
			- [ ] 在原本的地块上显示为一个GhostView(降低alpha值)，在移动到的终点显示玩家的sprite。
			- [ ] 细化对应的overlayTile显示图，不应该用![[用于显示移动范围-攻击范围的tile精灵图.png]]这个颜色，移动范围的显示tile图应该都是偏绿色的，详见ITB中的移动范围显示。
...
- [ ] 扩充敌人美术资产图的padding，让战斗中选中敌人的描边更加清晰
- [ ] 钩子改为十字范围类型的牌。
- [ ] 多次叠加虚弱buff失败(UI上显示有问题，不更新层数数字，runtimebuff中是有两层的，但是回合结束后仍然)，多次打出抽牌效果时候后续的牌打出之后没有该效果。敌人被buff弄死之后玩家会进行两个回合(第一个回合只抽牌)，抽两次牌。我们的重置模块目前的buff在回合开始时只会抽取一张牌，而不是卡面描述和配置中的value=2张。
